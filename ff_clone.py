'''
Follow https://www.facebook.com/F3K.Cyber.420
'''
#!/usr/bin/python3
...
def main():
    os.system('clear')
    print(Panel.fit(logo, subtitle=">[reverse violet]BD FF GAME ID CLONEING TOOL[/reverse violet]<"))
    print(Panel.fit("[bold green]Developer     —>>     Team R C S Rangpur Cyber Security"))
    print("")
    print(meth)
...
def file_subb(Gmail,psslist):
    global oks,done
    sys.stdout.write(f"\r  \033[38;5;46m[R C S-XD] {done}|{str(len(oks))}\r");sys.stdout.flush()
